...
export default function CFOControllerContent() {
  return (
    <div className="pt-20">
                ...
                <div className="relative bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-gray-800/20">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">Cash Flow</span>
                      </div>
                      <div className="text-lg font-bold text-blue-600 dark:text-blue-400">+15.2%</div>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-xl p-4 border border-green-200 dark:border-green-800">
                      ...
                      <div className="text-lg font-bold text-green-600 dark:text-green-400">22.8%</div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-4 border border-purple-200 dark:border-purple-800">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm font-semibold text-purple-700 dark:text-purple-300">KPIs</span>
                      </div>
                      <div className="text-lg font-bold text-purple-600 dark:text-purple-400">8/10</div>
                      <div className="text-xs text-purple-700 dark:text-purple-300">On track</div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-400">All metrics updated</span>
                    </div>
              ...
              <div className="relative w-full max-w-md">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-8 border border-blue-200/50 dark:border-blue-800/50">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-foreground">Financial Clarity</h3>
                      <p className="text-sm text-muted-foreground">Expert insights delivered</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-600" />
                      <span className="text-sm text-foreground">Cash flow optimization</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-600" />
                      <span className="text-sm text-foreground">Risk mitigation</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container-standard section-gutter">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <motion.div
                key={index}
                className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group text-center"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: true }}
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${
                  index % 2 === 0 ? 'from-blue-500 to-blue-600' : 'from-indigo-500 to-indigo-600'
                } rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-200`}>
        ...
        <div className="container-standard section-gutter">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            >
              ...
              <div className="text-sm opacity-90">Clients Nationwide</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="text-sm opacity-90">Average Profit Improvement</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="container-standard section-gutter">
          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="bg-slate-50 dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-gray-700 px-6">
      ...
      {/* Final CTA Banner */}
      <section className="py-32 md:py-40 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 text-white relative overflow-hidden">
        {/* Background Pattern */}
          ...
          >
            ...
            <div className="mt-16 pt-8 border-t border-white/20">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <Link href="/services/outsourced-accounting" className="text-sm hover:text-blue-300 transition-colors flex items-center gap-1">
                  Outsourced Accounting <ChevronRight className="h-3 w-3" />
                </Link>
                <Link href="/services/tax-preparation-compliance" className="text-sm hover:text-blue-300 transition-colors flex items-center gap-1">
